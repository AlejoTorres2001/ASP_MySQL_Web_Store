<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Busqueda.aspx.cs" Inherits="Alpaka.Busqueda" %>
<!DOCTYPE html>
...
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
      ...
      <!-- CSS -->
    <link href="Estilos/Busqueda.css" rel="stylesheet" />
    <!-- Bootstrap CSS -->
    <link
...
<body>
    ...
    <script src="Scripts/CargarBusquedas.js"></script>
     ...
     <div class="menu">
        <div>
           <header class="text-center">
                <h2 class="titulo-catalogo">Resultados</h2>
                </header>
        </div>
        <div class="productos">
          <div  id="catbusqueda" class="row" >
