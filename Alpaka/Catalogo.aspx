<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Catalogo.aspx.cs" Inherits="Alpaka.Catalogo" %>
...
<body>
    ...
    <script src="Scripts/CargarCatalgo.js"></script>
    <form id="form1" runat="server">
        ...
        <div class="menu">
            <div>
                ...
                <asp:ListBox ID="ListBox1" runat="server" CssClass="auto-style1" Height="26px" Width="140px">
                ...
                <asp:Label ID="Label3" runat="server" Text="Talle/Tamaño: "></asp:Label>
                <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="buscar" CssClass="boton boton-guardar" Width="98px" />


            </div>
         <header class="text-center">
           <h2 class="titulo-catalogo">Mujeres</h2>

         </header>
        </div>
        <div class="productos">
        <h4 class="titulo-catalogo-secundario">Remeras</h4>
          <div  id="catmujeresremera" class="row" >
            
          </div>
        <h4 class="titulo-catalogo-secundario">Pantalones</h4>
          <div  id="catmujerespantalones" class="row" >
        ...
        <div class="menu">
          <header class="text-center">
           <h2 class="titulo-catalogo">Hombres</h2>
 
          </header>
         </div>
         <div class="productos">
             <h4 class="titulo-catalogo-secundario">Remeras</h4>
          <div  id="cathombresremeras" class="row" >
            
          </div>
             <h4 class="titulo-catalogo-secundario">Pantalones</h4>
          <div  id="cathombrespantalones" class="row" >
            
          </div>
           <div class="row " id="cathombres">
            <!-- Catalogo Accsesorios -->
             </div>
        <div class="menu">
          <header class="text-center">
            <h2 class="titulo-catalogo">Accesorios</h2>
 
          </header>
         </div>
         <div class="productos">
           <h4 class="titulo-catalogo-secundario">Perfumes</h4>
          <div  id="cataccperfumes" class="row" >
            
          </div>
             <h4 class="titulo-catalogo-secundario">Bijouterie</h4>
          <div  id="cataccbijouterie" class="row" >
            
          </div>
             <div>

                 <asp:Button CssClass="btn-grad pagar" ID="Button1" runat="server" Text="Agregar al Carrito" OnClick="Button1_Click" />

             </div>
            <!-- Fin catalogo Accessorios -->
