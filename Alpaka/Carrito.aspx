<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Carrito.aspx.cs" Inherits="Alpaka.Carrito" %>
...
<body>
    ...
    <script src="Scripts/CargarCarrito.js"></script>
        ...
        <header class="header">
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div>
                ...
                <asp:Button ID="Button1" CssClass="btn-grad-limpiar limpiar" runat="server" Text="Limpiar carrito" OnClick="Button1_Click" />
       ...
       <form method="post">
        ...
        <div class="menu">
          <header class="text-center">
            <h2 class="titulo-catalogo">Carrito de compras</h2>
          </header>
         </div>
         <div class="productos">
        ...
        <a class="btn-grad pagar" href="Pagar.aspx">Pagar</a>
        <!-- fin carrito -->
        <!-- footer -->
