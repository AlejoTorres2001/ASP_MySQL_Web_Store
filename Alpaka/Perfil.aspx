<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Perfil.aspx.cs" Inherits="Alpaka.Perfil" %>
...
<body>
    ...
    <script src="Scripts/PerfilSwal.js"></script>
    <script src="Scripts/CargarPefil.js"></script>
    <script src="Scripts/CargarfotoPerfil.js"></script>
    ...
    <form id="form1" runat="server">
      ...
      <center>
        <div class="box">
           <asp:Image ID="Image1" CssClass="foto-perfil" runat="server"></asp:Image>
          <INPUT id="oFile" type="file" runat="server" NAME="oFile">
          <label for="oFile">Foto</label>
            <br />
            <br />
            <br />
            <br />
          ...
          <input type="text" name="tel" placeholder="numero de telefono" id="tel"/>
          ...
          <asp:Button class="boton boton-guardar" ID="Button1" runat="server" Text="Log out" Width="100px" OnClick="Button1_Click"/>
           <asp:Button ID="guardarfoto" CssClass="boton boton-guardar" runat="server" Text="Guardar" OnClick="guardarfoto_Click"></asp:Button>

          </form>
          <a class="boton boton-guardar" href="EnvioHistorial.aspx">Compras</a>
        </div>
      </center>
      <br />
      <br />
      ...
      <footer class="text-white bg-dark pt-0 pb-4">
        <div class="container text-center text-md-end">
          <div class="row text-center bg-dark text-md-end">
            <div class="col-md-3 col-lg-3 bg-dark col-xl-3 mx-auto mt-3">
