<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Administracion.aspx.cs" Inherits="Alpaka.Administracion" %>
...
<body>
    ...
    <script src="Scripts/AdministracionSwal.js"></script>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" arial-labelledby="navbarDropdown">
                      ...
                      <br />
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="Catalogo.aspx">Para ellas</a>
                      <br />
                      <br />
                      <div class="dropdown-divider"></div>
        ...
        <div>
            ...
            <table class="w-100">
                <tr>
                    ...
                    <td rowspan="9">
                        <asp:TextBox ID="TextBox5" runat="server" Height="185px" Width="375px" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style2">Talle</td>
                    <td class="auto-style1">
                ...
                <tr>
                    <td class="auto-style2">Composicion</td>
                    <td class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style3">Listado de Usuarios</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style1">
                        <asp:TextBox ID="txtimagen" runat="server" Width="438px"></asp:TextBox>
                    </td>
                    <td class="auto-style3">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style5">
                        <asp:DropDownList ID="dplistcat" runat="server" Width="167px">
                            <asp:ListItem>hombre</asp:ListItem>
                            <asp:ListItem>mujeres</asp:ListItem>
                            <asp:ListItem Value="accesorios">accesorios</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class="auto-style6"></td>
                </tr>
                <tr>
                    <td class="auto-style2">SubCategoria</td>
                    <td class="auto-style1">
                        <asp:DropDownList ID="dplistsubcat" runat="server" Width="167px">
                            <asp:ListItem>remeras</asp:ListItem>
                            <asp:ListItem>pantalones</asp:ListItem>
                            <asp:ListItem>perfumes</asp:ListItem>
                            <asp:ListItem>bijouterie</asp:ListItem>
                        </asp:DropDownList>
                        <br />
                        <asp:Button ID="Button1" runat="server" Text="Cargar" Width="94px" OnClick="Button1_Click" />
                        <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Eliminar" Width="95px" />
                        <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="Buscar" Width="85px" />
                        <asp:Button ID="Button5" runat="server" OnClick="Button5_Click" Text="Actualizar" Width="94px" />
                    </td>
                    <td class="auto-style3">
                        <asp:Button ID="Button2" runat="server" Text="Mostrar" Width="104px" OnClick="Button2_Click" />
                    </td>
                </tr>
            </table>
